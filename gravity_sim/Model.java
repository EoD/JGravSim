...
public class Model {
	...
	public void writetempHeader(double datacount, double timecount) {
		...
		writetempout(version+";"+steps+";"+steptime+"\n", filename);
	}
	...
	public int correctHeader(File infile, int newSteps) {
		try {
			...
			String snewCurLine = saCurLine[0]+";"+snewSteps+";"+saCurLine[2]+"\n";//sCurLine.substring(sCurLine.indexOf(';')+1,sCurLine.lastIndexOf(';'));
	...
	public void AddStep(Vector<Masspoint> OneData) {
    	...
    	for(int i=0;i<OneData.size();i++) {
			...
			String vx = String.valueOf(mp.mdvzerospeed.x1 * mp.dabsspeed); 
			String vy = String.valueOf(mp.mdvzerospeed.x2 * mp.dabsspeed); 
			String vz = String.valueOf(mp.mdvzerospeed.x3 * mp.dabsspeed);  
			...
			writetempout(id+";"+mass+";"+radius+";"+vx+";"+vy+";"+vz+";"+ax+";"+ay+";"+az+";"+px+";"+py+";"+pz+"\n", filename);	                                                                                                                                                                    
    	}
	}
	...
	public int loadDataset(File infile) {
		...
		//System.out.println("Parsing Inputfile: "+infile.getName());
