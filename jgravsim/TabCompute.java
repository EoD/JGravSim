	...
	public TabCompute(XMLParser parser) {
		...
		pa_comp_middle.add(pa_comp_middleview);
			...
			pa_comp_middlebuttons.setLayout(new BoxLayout(pa_comp_middlebuttons, BoxLayout.Y_AXIS));
				...
				Controller.mpdf_moon.name 	= 	myXMLParser.getText(500);
				Controller.mpdf_sun.name	= 	myXMLParser.getText(501);
				Controller.mpdf_mercury.name = 	myXMLParser.getText(502);
				Controller.mpdf_venus.name 	= 	myXMLParser.getText(503);
				Controller.mpdf_earth.name 	= 	myXMLParser.getText(504);
				Controller.mpdf_mars.name 	= 	myXMLParser.getText(505);
				Controller.mpdf_jupiter.name = 	myXMLParser.getText(506);
				Controller.mpdf_saturn.name = 	myXMLParser.getText(507);
				Controller.mpdf_uranus.name = 	myXMLParser.getText(508);
				Controller.mpdf_neptune.name = 	myXMLParser.getText(509);
				Controller.mpdf_ceres.name 	= 	myXMLParser.getText(510);
				Controller.mpdf_pluto.name 	= 	myXMLParser.getText(511);
				Controller.mpdf_eris.name 	= 	myXMLParser.getText(512);
				Controller.mpdf_proxima_centauri.name = myXMLParser.getText(513);
				Controller.mpdf_alpha_centauri_a.name = myXMLParser.getText(514);
				Controller.mpdf_rigel.name	= 	myXMLParser.getText(515);
				Controller.mpdf_zeta_puppis.name = 	myXMLParser.getText(516);
				Controller.mpdf_sirius_b.name 	= 	myXMLParser.getText(517);
				Controller.mpdf_cygnus_x1.name 	= 	myXMLParser.getText(518);
